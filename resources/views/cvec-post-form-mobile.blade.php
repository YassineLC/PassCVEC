...
<body>
            ...
            <div class="card-body">
                <form name="add-post-form" id="add-post-form" method="POST" action="{{url('store-form')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="adresse" name="adresse" class="form-control" required value ="{{ old('adresse') }}" placeholder="10 Rue de l'Exemple">
                        @error("adresse")
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group form-check mt-4">
                        ...
                        <label for="newsletter_subscription" class="form-check-label">Je souhaite recevoir la newsletter du pass CVEC</label>
                    </div>
    ...
    <script src="{{ asset('js/cvec-post-form-mobile.js') }}"></script>
    <script>
        $(function () {
